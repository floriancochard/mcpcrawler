...
const comparisonData = [
  {
    title: "Pages crawled per second (1000 pages)",
    data: [
  ...
  {
    title: "% relevant content for LLMs",
    data: [
      { name: "MCPCrawler", value: 95, color: "#000000" },
  ...
  return (
    <Section>
      <div className="flex flex-col items-start space-y-4 text-left">
        <h2 className="font-heading text-3xl leading-[1.1] sm:text-3xl md:text-6xl">Enterprise-grade performances</h2>
      ...
      <div className="grid gap-8">
        <Tabs defaultValue="speed" className="w-full">
          <TabsList className="grid w-full grid-cols-3 h-12">
            <TabsTrigger value="speed" className="cursor-pointer">
              Speed
            </TabsTrigger>
            <TabsTrigger value="cost" className="cursor-pointer">
              Cost
            </TabsTrigger>
            <TabsTrigger value="relevance" className="cursor-pointer">
              Relevance
            </TabsTrigger>
          </TabsList>
